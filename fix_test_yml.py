...
content = re.sub(
    r'(HINDSIGHT_API_LLM_VERTEXAI_SERVICE_ACCOUNT_KEY: /tmp/gcp-credentials.json)',
    r'\1\n      HINDSIGHT_API_SKIP_LLM_VERIFICATION: true\n      HINDSIGHT_API_LLM_VERTEXAI_PROJECT_ID: dummy',
    content
)

content = re.sub(
    r'(HINDSIGHT_API_LLM_VERTEXAI_SERVICE_ACCOUNT_KEY: \${{ github.workspace }}/gcp-credentials.json)',
    r'\1\n      HINDSIGHT_API_SKIP_LLM_VERIFICATION: true\n      HINDSIGHT_API_LLM_VERTEXAI_PROJECT_ID: dummy',
    content
)
