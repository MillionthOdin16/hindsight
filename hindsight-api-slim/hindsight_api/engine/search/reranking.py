...
class CrossEncoderReranker:
    ...
    async def rerank(self, query: str, candidates: list[MergedCandidate]) -> list[ScoredResult]:
        ...
        # Performance: Use standard library math.exp instead of numpy.exp for single
        # scalar operations to avoid Python-to-C conversion overhead.
        # math.exp raises OverflowError for large negative inputs instead of returning 0.
