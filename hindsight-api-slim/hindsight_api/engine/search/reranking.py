...
class CrossEncoderReranker:
    ...
    async def rerank(self, query: str, candidates: list[MergedCandidate]) -> list[ScoredResult]:
        ...
        # ⚡ Bolt: using math.exp instead of numpy.exp for scalar operations avoids Python-to-C overhead.
        # Math.exp raises OverflowError for large inputs, which we handle by returning 0.0
