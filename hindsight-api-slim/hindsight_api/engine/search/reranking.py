...
class CrossEncoderReranker:
    ...
    async def rerank(self, query: str, candidates: list[MergedCandidate]) -> list[ScoredResult]:
        ...
        # PERF: Using math.exp for scalar values is significantly faster than np.exp
        # as it avoids the overhead of converting to/from numpy arrays. We handle
        # OverflowError because math.exp raises on large negative inputs, while
        # np.exp would return 0.0.
